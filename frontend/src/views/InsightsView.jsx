...
// import { Sparkles, Layout, MessageSquare, Search, Quote, Clock, Filter } from "lucide-react";
...
//               <div key={insight.id} className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
...
//                 <div className="flex items-start gap-2 text-xs text-slate-400 italic mb-3">
...
import React, { useState, useEffect, useCallback } from "react";
import { Sparkles, Layout, MessageSquare, Search, Quote, Clock, Filter, Check, X, Download } from "lucide-react";
...
export default function InsightsView({ onNavigate }) {
  ...
  const updateStatus = async (id, newStatus) => {
    ...
    try {
      ...
      fetchInsights(); // revert on failure by refetching real state
    }
  };
